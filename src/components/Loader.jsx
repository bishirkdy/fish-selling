    ...
    <StyledWrapper className="bg-(--color-background) z-100 w-screen h-screen flex items-center justify-center">
      <div>
        <section className="loader bg-(--color-background)">
          ...
          <svg height="200px" width="200px" version="1.1" className="fish" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xmlSpace="preserve" fill="#000000">
            <g strokeWidth={0} />
            <g strokeLinecap="round" strokeLinejoin="round" />
            <g>
              <path style={{fill: '#3c66b1'}} d="M155.225,223.377c0,0,37.189-90.859,144.589-91.34c100.768-0.451,124.753,59.527,124.753,59.527 L155.225,223.377z" />
              <path style={{fill: '#8ec1ed'}} d="M267.842,339.889c-89.137-24.416-179.415-81.052-179.415-81.052s140.421-92.038,253.44-92.038 s162.587,121.482,162.587,121.482s-49.567,62.594-162.587,62.594c-7.464,0-15.002-0.401-22.575-1.151L267.842,339.889z" />
              <g style={{opacity: '0.4'}}>
                <path style={{fill: '#3c66b1'}} d="M504.454,288.279c0,0-31.461-77.103-101.402-108.457c-16.687,7.061-52.699,48.747-53.584,82.508 c-0.941,35.906,12.738,68.547,41.995,84.212C469.521,332.375,504.454,288.279,504.454,288.279z" />
              </g>
              <g>
                <path style={{opacity: '0.23', fill: '#315591', enableBackground: 'new'}} d="M341.867,318.829c-7.464,0-15.002-0.401-22.575-1.151 l-51.451-9.835C208.667,291.633,149,261.23,115.566,242.618c-17.003,9.71-27.139,16.352-27.139,16.352 s90.277,56.635,179.415,81.052l51.451,9.836c7.573,0.75,15.111,1.151,22.575,1.151c113.019,0,162.587-62.594,162.587-62.594 s-3.513-8.607-10.796-21.237C473.573,285.121,424.806,318.829,341.867,318.829z" />
                <path style={{fill: '#315591'}} d="M504.453,295.827h-51.719c-4.169,0-7.546-3.379-7.546-7.546s3.378-7.546,7.546-7.546h51.719 c4.169,0,7.546,3.379,7.546,7.546S508.622,295.827,504.453,295.827z" />
                <path style={{fill: '#315591'}} d="M349.468,268.867c0,0,0.053,91.146-81.623,111.099v-91.062c0-10.128,8.092-18.402,18.217-18.627 L349.468,268.867z" />
